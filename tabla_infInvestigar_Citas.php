<?php
    ...
    $ssql = "SELECT InfInvCitas.id_registro,
                    t.nombre_tipificacion AS estado,
                    DATE_FORMAT(InfInvCitas.fecha_registro, '%d/%m/%Y') AS fechaRegistro,
...
<!-- Scripts -->       
    <title>Inf Investigar Citas - Gestion Contact</title>
</head>
<body>
<header>
    <?php 
    ...
    <section>
        ...
        <div>   
        <span class=""><h2>Inf Investigar <b>Citas</b></h2></span>
        ...
        <table id="registros" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                <?php foreach ($qsqlDatos as $dato) { ?>
                    <tr>
                        <form action="infInvestigarCitas_gestor.php" method="post">
