$(document).ready(function(){
    ...
    $("#form_preparaciones_gestor").on("submit",function(e){
        e.preventDefault();


        var parametros = new FormData($("#form_preparaciones_gestor")[0]);
        var btnEnviar = $("#btnEnviar_preparacionesGestor");
        ...
        const swalWithBootstrapButtons = Swal.mixin({
          ...
          swalWithBootstrapButtons.fire({
            ...
            $.ajax({
                data:parametros,
                url:"././sistema/logica/ajax_formularios/form_preparaciones_gestor.php",
                type:"POST",
                contentType:false,
                processData:false,
                beforeSend: function(){
                ...
                success: function(data){
                    ...
                    $("body").append(data);
                    setTimeout(function () {
                      window.location = "./././tabla_envioPreparaciones.php";
