...
<?php
	...
	if (!empty($_POST)) {
        // Declaracion de variables que se mostraran segun sus campos designados" //
            ...
            $query = mysqli_query($con,"UPDATE permisos SET ConsultorFono = '$ConsultorFono', AgenteCitas = '$AgenteCitas', GestorFono = '$GestorFono', 
