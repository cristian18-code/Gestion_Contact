<?php
    ...
    $ssql = "SELECT mantenimiento.id_registro,
                    DATE_FORMAT(mantenimiento.fechaRegistro, '%d/%m/%Y') AS fecha_registro,
                    mantenimiento.horaRegistro,
                    mantenimiento.documento,
                    mantenimiento.contrato,
                    mantenimiento.nombres_usuario
                    FROM mantenimiento_posventa mantenimiento
...
<!-- Scripts -->       
    <title>Mantenimiento Pos - Gestion Contact</title>
</head>
<body>
<header>
    <?php 
    ...
    <section>
        ...
        <div>   
        <span class=""><h2>Registros Mantenimiento Posventa <b>FONOPLUS</b></h2></span>
        ...
        <table id="registros" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                <?php foreach ($qsqlDatos as $dato) { ?>
                    <tr>
                        <form action="mantenimientoPos_gestor.php" method="post">
