<?php
    ...
    $ssql = "SELECT investigar.id_registro,
                    ...
                    DATE_FORMAT(investigar.fechaRegistro, '%d/%m/%Y'),
                    investigar.horaRegistro,
                    investigar.nombresUsuario
                    FROM ((inf_investigar investigar INNER JOIN usuarios ON investigar.id_userCrea = usuarios.id_usuario)
...
<header>
    ...
    <section>
        ...
        <div>   
        <span class="subtitulo"><h2>Registros <b>Informacion a investigar citas</b></h2></span>
                ...
                <?php foreach ($qsqlDatos as $dato) { ?>
                    <tr>
                        <form action="infInvestigar_gestor.php" method="post">
                            ...
                            <td><?php echo $dato["tipificacion_incidencia"]; ?></td>
