<?php
    ...
    $ssql = "SELECT reversiones.id_registro,
                    DATE_FORMAT(reversiones.fechaRegistro, '%d/%m/%Y') AS fecha_registro,
                    reversiones.horaRegistro,
                    reversiones.documento,
                    reversiones.contrato,
                    reversiones.usuario
                    FROM (reversiones_fono reversiones)
                    WHERE reversion_efectiva = '' OR reversion_efectiva  IS NULL";
...
<!-- Scripts -->       
    <title>Reversiones Gestor - Gestion Contact</title>
</head>
<body>
<header>
    <?php 
    ...
    <section>
        ...
        <div>   
        <span class=""><h2>Reversiones Gestor <b>FONOPLUSS</b></h2></span>
        ...
        <table id="registros" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                <?php foreach ($qsqlDatos as $dato) { ?>
                    <tr>
                        <form action="reversiones_gestor.php" method="post">
