<?php
    ...
    $ssql = "SELECT autorizaciones.id_registro,
                    ...
                    WHERE id_tipificacionEstado != '86' OR id_tipificacionEstado IS NULL";
...
<!-- Scripts -->       
    <title>Autorizaciones- Gestion Contact</title>
</head>
<body>
<header>
    <?php 
    ...
    <section>
        ...
        <div>   
        <span class=""><h2>Registros Autorizaciones <b>FONOPLUS</b></h2></span>
        ...
        <table id="registros" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                <?php foreach ($qsqlDatos as $dato) { ?>
                    <tr>
                        <form action="autorizaciones_gestor.php" method="post">
                            <td><?php echo $dato['id_registro']; ?></td>
                            <td><?php echo $dato['Servicio_solicitado']; ?></td>
